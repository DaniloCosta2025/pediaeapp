...
// Observação: em ambientes serverless (Vercel), carregue variáveis via painel de Environment Variables
...
// Initialize Firebase Admin for FCM se FIREBASE_SERVICE_ACCOUNT_JSON estiver definido
try {
  let svc = null
...
// Start server only in standalone mode (not in serverless like Vercel)
